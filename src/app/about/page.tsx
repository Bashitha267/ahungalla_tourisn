    ...
    <div className="w-full min-h-screen py-12 bg-slate-50/30 dark:bg-slate-950/20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-white dark:bg-slate-900/40 p-6 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-sm relative overflow-hidden">
          {/* Subtle decoration */}
          <div className="absolute -top-10 -right-10 w-40 h-40 bg-cyan-600/5 dark:bg-teal-400/5 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-cyan-600/5 dark:bg-teal-400/5 rounded-full blur-3xl pointer-events-none" />
          ...
          >
            <div className="relative h-60 w-60 sm:h-64 sm:w-64 rounded-2xl overflow-hidden shadow-md border-4 border-white dark:border-slate-800 ring-2 ring-cyan-600/10 dark:ring-teal-400/15">
              <Image
                src="/owner.jpeg"
            ...
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-cyan-50 dark:bg-teal-400/10 text-cyan-700 dark:text-teal-300 border border-cyan-100 dark:border-teal-400/20">
          ...
          >
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-2 text-sm font-semibold text-slate-650 dark:text-slate-300">
                ...
                <span className="text-cyan-600 dark:text-teal-300 font-bold">{t('about.berty.licence')}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-slate-100 dark:border-slate-800/80">
              <div className="space-y-3">
                ...
                <div className="space-y-2.5 text-xs sm:text-sm text-slate-650 dark:text-slate-350">
                  <a href="tel:+94776920730" className="flex items-center gap-2 hover:text-cyan-600 dark:hover:text-teal-300 transition-colors font-medium">
                    <Phone className="h-4 w-4 text-cyan-600 dark:text-teal-300 shrink-0" />
                    <span>+94 77 692 0730</span>
                  </a>
                  <a href="mailto:bertyssr@gmail.com" className="flex items-center gap-2 hover:text-cyan-600 dark:hover:text-teal-300 transition-colors font-medium">
                    <Mail className="h-4 w-4 text-cyan-600 dark:text-teal-300 shrink-0" />
                    <span>bertyssr@gmail.com</span>
                  </a>
                  <div className="flex items-start gap-2 font-medium">
                    <MapPin className="h-4 w-4 text-cyan-600 dark:text-teal-300 shrink-0 mt-0.5" />
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2.5 text-xs sm:text-sm text-slate-650 dark:text-slate-355">
                  ...
                  <div className="flex items-center gap-2 font-medium">
                    <Car className="h-4 w-4 text-cyan-600 dark:text-teal-300 shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-6 space-y-3">
                <div className="flex items-center space-x-2 text-cyan-600 dark:text-teal-300">
            ...
            {[
              ...
              return (
                <div key={i} className="glass p-6 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-3">
                  <div className="h-10 w-10 rounded-xl bg-cyan-600/10 text-cyan-600 dark:bg-teal-400/10 dark:text-teal-300 flex items-center justify-center">
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {feedbacks.map((f, i) => (
              ...
              >
                <div className="absolute top-4 right-4 text-cyan-600/5 dark:text-teal-400/5 pointer-events-none">
                ...
                <div className="flex items-center space-x-3.5 pt-3 border-t border-slate-200/50 dark:border-slate-800/50">
                  <div className="relative h-10 w-10 rounded-full overflow-hidden border border-cyan-600/30 dark:border-teal-400/30">
                    <Image
                      src={f.avatar}
                      alt={f.name}
                      fill
